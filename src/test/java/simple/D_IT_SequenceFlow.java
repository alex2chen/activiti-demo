 ...
 * @date 2017/2/14
 */
public class D_IT_SequenceFlow {
    ...
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/bpmn/sequenceFlow.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/bpmn/sequenceFlow.png");
    ...
    public void completeMyPersonalTask() {
        ...
        //variables.put("message", "不重要"); // 流程实例部署的时候，要先获得对应的任务

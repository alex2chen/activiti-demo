...
public class L_IT_Task {
    ...
    public void deploymentProcessDefinition_inputStream(){
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/bpmn/task.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/bpmn/task.png");

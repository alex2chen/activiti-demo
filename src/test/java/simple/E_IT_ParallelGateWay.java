 ...
 * @date 2017/2/14
 */
public class E_IT_ParallelGateWay {
    ...
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/bpmn/parallelGateWay.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/bpmn/parallelGateWay.png");
    ...
    public void startProcessInstance() {
        String processDefinitionKey = "parallelGateWay"; // 使用Key的启动，默认按照对心版本的流程定义启动

...
public class G_IT_Start {
    ...
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/bpmn/start.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/bpmn/start.png");

 ...
 * @date 2017/2/14
 */
public class F_IT_ExclusiveGateWay {
    private ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();

    @Test
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/bpmn/exclusiveGateWay.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/bpmn/exclusiveGateWay.png");
    ...
    public void startProcessInstance() {
        String processDefinitionKey = "exclusiveGateWay"; // 使用Key的启动，默认按照对心版本的流程定义启动
...
//							.deleteDeployment(deploymentId);
    ...
    public void completeMyPersonalTask() {
        ...
        //variables.put("money", 800); // case1：800
        //variables.put("money", 800); // case1：800
